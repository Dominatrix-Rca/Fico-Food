    ...
    <div className="container flex flex-row leading-relaxed ">
      <div className="w-1/6 bg-black h-screen block border border-2xl rounded-lg   border-white">
        <p className="flex flex-row justify-start ml-4 items-center pt-12 ">
          <span className="text-orange-400 text-2xl font-bold tracking-wider">
            Eat-
          </span>
        ...
        <div className="block mt-4 pt-4">
          <div className="flex flex-row ml-4  w-3/4 my-8 h-8 justify-between hover:border-l-4 border-orange-300">
            <AiFillPieChart className="text-white text-xl mt-2 ml-2" />
            <p className=" text-white text-xl text-center font-sansserif font-semibold  mr-1 mt-1">
              Overview
            </p>
          </div>
          <div className="flex flex-row ml-4   w-3/4 my-8 h-8 justify-between hover:border-l-4 border-orange-300">
            <FaTicketAlt className="text-gray-100 opacity-25 text-xl mt-2 ml-2" />
            <p className="text-gray-100 opacity-25  text-xl text-center font-sansserif font-semibold mr-7 mt-1">
              Clients
            </p>
          </div>
          <div className="flex flex-row ml-4  w-3/4 my-8 h-8 justify-between hover:border-l-4 border-orange-300">
            <HiUserGroup className="text-gray-100 opacity-25 text-xl mt-2 ml-2" />
            <p className="text-gray-100 opacity-25 text-xl text-center font-sansserif font-semibold mr-9 mt-1">
              Users
            </p>
          </div>
        </div>
        <div className="block mt-8 py-4">
          <div className="flex flex-row ml-4  w-3/4 my-8 h-8 justify-between hover:border-l-4 border-orange-300">
            ...
            <p className="text-gray-100 opacity-25  text-xl text-center font-sansserif font-semibold mr-3 mt-1">
              Settings
            </p>
          </div>
          <div className="flex flex-row ml-4  h-4 w-3/4 my-8 h-8 justify-between hover:border-l-4 border-orange-300 hover:bg-black   ">
            ...
            <p className="text-gray-100 opacity-25  text-xl text-center font-sansserif font-semibold  mt-1 hover:text-white  ">
              My account
            </p>
          </div>
        </div>
      ...
      <div className="w-5/6 bg-indigo-100 opacity-3  h-screen block py-4  ">
        ...
        <div className=" bg-white mx-4 h-4/6 my-16 py-3 border-2 border-indigo-200 block  ">
          ...
          <div className="comb block  h-full ">
